...
const FreeShipping = () => {
  return (
    <div className="container ">
      <div className=" grid grid-cols-1 text-center  md:flex justify-between items-center border-2 border-primary my-10 md:my-16 p-6">
        <div className=" flex items-center gap-2 text-center justify-center">
            <FaShippingFast size={40} className=" hidden md:block" />
